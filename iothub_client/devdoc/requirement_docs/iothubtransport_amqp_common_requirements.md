...
**SRS_IOTHUBTRANSPORT_AMQP_COMMON_09_090: [**on_message_received_callback shall return DEVICE_MESSAGE_DISPOSITION_RESULT_ACCEPTED if the IoTHubClient_LL_MessageCallback() returns IOTHUBMESSAGE_ACCEPTED**]**
**SRS_IOTHUBTRANSPORT_AMQP_COMMON_09_091: [**on_message_received_callback shall return DEVICE_MESSAGE_DISPOSITION_RESULT_ABANDONED if the IoTHubClient_LL_MessageCallback() returns IOTHUBMESSAGE_ABANDONED**]**
**SRS_IOTHUBTRANSPORT_AMQP_COMMON_09_092: [**on_message_received_callback shall return DEVICE_MESSAGE_DISPOSITION_RESULT_REJECTED if the IoTHubClient_LL_MessageCallback() returns IOTHUBMESSAGE_REJECTED**]**
