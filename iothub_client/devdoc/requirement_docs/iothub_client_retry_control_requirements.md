...
**SRS_IOTHUB_CLIENT_RETRY_CONTROL_09_033: [**If `retry_control->policy_name` is IOTHUB_CLIENT_RETRY_RANDOM, calculate_next_wait_time shall return (`retry_control->initial_wait_time_in_secs` * (rand() / RAND_MAX))**]**
